...
<table bordercolor="#66b2b2">
  ...
  <tr>
    <td width="50%" valign="top">
      <h3 align="center">COMPASS Adventures</h3>
        <br />
        <a target="_blank" href="https://compass-adventures.netlify.app/>
            <img src="" width="100%" alt="COMPASS Adventures"/>
        </a>
        <br />
        <p align="center">
          
  <a href="https://github.com/christophermorin/compass_adventures" target="_blank">
    <img src="https://img.shields.io/static/v1?label=|&message=REPO&color=23555f&style=plastic&logo=github&logo-color=white"/>
  </a>  
  <a href="https://compass-adventures.netlify.app/" target="_blank">
    <img src="https://img.shields.io/static/v1?label=|&message=WEBSITE&color=cdf998&style=plastic&logo=wordpress&logo-color=white"/>
  </a>
      </p>
        <p><strong>Javascript, HTML5,CSS3</strong> - Fully responsive landing site that can be tailored and expanded to fit any buisnesses needs.</p>
    </td>
    <td width="50%" valign="top">
  ...
  <a href="https://github.com/christophermorin/portfolio" target="_blank">
    <img src="https://img.shields.io/static/v1?label=|&message=REPO&color=23555f&style=plastic&logo=github&logo-color=white"/>
  </a>
